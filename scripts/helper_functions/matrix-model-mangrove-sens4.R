...
mangrove_project5 <- function(country, PF, UF, PD, UD, # initial states
                             ...
                             PR.target, RR.target, rest.fail){ # restoration target 
  ...
  # set restoration constant - ha in each year, proportion of restorable forest area in conservation start year
    ...
    for(i in 1:years){
      ...
      if(cons.start+i > target.year.protect & sum(ls[[i]][3,], ls[[i]][4,]) > RR){# if past target year for protection, don't protect
          ...
          states2[2,1] <- states2[2,1] + RR - RR.fail
        ...
        states2[2,1] <- states2[2,1] - PR + RR - RR.fail
        states2[3,1] <- states2[3,1] - (RR*(states2[3,1]/(states2[3,1]+states2[4,1])))
        states2[4,1] <- states2[4,1] - (RR*(states2[4,1]/(states2[3,1]+states2[4,1])))
        states2[5,1] <- states2[5,1] + RR.fail
        ls[[i+1]] <- states2
        ...
        states2[2,1] <- states2[2,1] - states2[2,1] + RR - RR.fail
        states2[3,1] <- states2[3,1] - (RR*(states2[3,1]/(states2[3,1]+states2[4,1])))
        states2[4,1] <- states2[4,1] - (RR*(states2[4,1]/(states2[3,1]+states2[4,1])))
        states2[5,1] <- states2[5,1] + RR.fail
        ls[[i+1]] <- states2
        ...
        states2 <-  trans %*% ls[[i]]
        states2[1,1] <- states2[1,1] + PR 
        states2[2,1] <- states2[2,1] - PR + states2[4,1] + states2[3,1] - ((states2[4,1] + states2[3,1]) * rest.fail)
        states2[3,1] <- states2[3,1] - states2[3,1]
        states2[4,1] <- states2[4,1] - states2[4,1]
        states2[5,1] <- states2[5,1] + (states2[4,1] + states2[3,1]) * rest.fail
        ls[[i+1]] <- states2
        ...
        states2 <-  trans %*% ls[[i]]
        states2[1,1] <- states2[1,1] + states2[2,1]
        states2[2,1] <- states2[2,1] - states2[2,1] + states2[4,1] + states2[3,1] - ((states2[4,1] + states2[3,1]) * rest.fail)
        states2[3,1] <- states2[3,1] - states2[3,1]
        states2[4,1] <- states2[4,1] - states2[4,1]
        states2[5,1] <- states2[5,1] + (states2[4,1] + states2[3,1]) * rest.fail
        ls[[i+1]] <- states2
